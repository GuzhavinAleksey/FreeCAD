macro(PrintFinalReport)
    ...
    if(BUILD_OPENVR)
        if(DEFINED OPENVR_FOUND)
            message(STATUS "OpenVR:                [${OpenVR_LIBRARY}] [${OpenVR_INCLUDE_DIR}]")
        else(DEFINED OPENVR_FOUND)
            message(STATUS "OpenVR:                not found")
        endif(DEFINED OPENVR_FOUND)
    else(BUILD_OPENVR)
        message(STATUS "OpenVR:                not enabled (BUILD_OPENVR)")
    endif(BUILD_OPENVR)
